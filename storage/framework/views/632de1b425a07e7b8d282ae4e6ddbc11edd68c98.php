    ...
    <div class="col-md-12">
        <div class="col-md-2" style="padding-top:2%;">
            <div class="btn-group-vertical">
                ...
                <!--
                <a href="get_message/<?php echo e($dep_id); ?>/<?php echo e($id); ?>">button</a>
                -->
                <a type="button" class="btn btn-default">Home</a>
                <a type="submit" class="btn btn-info" href="get_message/<?php echo e($dep_id); ?>/<?php echo e($id); ?>">Messages</a>
                <!--
